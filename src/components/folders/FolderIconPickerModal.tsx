      ...
      <Dialog.Portal>
        ...
        >
          ...
          <div className="px-4 pb-4">
            <div
              ref={scrollRef}
              className="ui-scrollbar-overlay h-[22rem] overflow-auto rounded-[var(--ui-radius-lg)] border border-border/80 bg-bg-secondary/70 p-2.5 scrollbar-gutter-stable"
            >
